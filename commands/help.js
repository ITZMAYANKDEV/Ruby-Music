  ...
  run: async (client, interaction) => {
    try {
      ...
      const basicCommandsEmbed = new EmbedBuilder()
       ...
       .setImage('https://share.creavite.co/65fd2843c1fd3ec562e5431e.gif')
      const button1 = new ButtonBuilder()
        .setLabel('YouTube')
        .setURL('https://www.youtube.com/@Rubyzoneyt')
        .setStyle(ButtonStyle.Link);

      const button2 = new ButtonBuilder()
        .setLabel('Discord')
        .setURL('https://discord.gg/kjHrHaKyqn')
        .setStyle(ButtonStyle.Link);

      const button3 = new ButtonBuilder()
        .setLabel('Instagram')
        .setURL('https://www.instagram.com/ig.mayank.gupta/')
        .setStyle(ButtonStyle.Link);
